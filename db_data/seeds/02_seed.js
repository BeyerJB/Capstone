...
exports.seed = async function(knex) {
  ...
  await knex('calendar_users').insert([
    ...
    { first_name: 'Olivia', last_name: 'Thomas', rank: 1, username: 'oliviathomas', user_type: 1, team_id: 1, password: await bcrypt.hash('password', 10), enabled: true, pending: false },
    ...
    { first_name: 'Ava', last_name: 'Garcia', rank: 1, username: 'avagarcia', user_type: 1, team_id: 1, password: await bcrypt.hash('password', 10), enabled: true, pending: false },
  ...
  await knex('calendar_events').insert([
    ...
    { title: 'Training 2', start_datetime: '2024-04-23T13:00:00', end_datetime: '2024-04-23T16:00:00', user_id: 5, description: 'Training session', event_type: 3, creator_id: 2, pending: false, approved: true },
    ...
    { title: 'Team Building Event', start_datetime: '2024-04-26T09:00:00', end_datetime: '2024-04-26T17:00:00', team_id: 1, description: 'Team building activities', event_type: 2, creator_id: 2, pending: false, approved: true },
    { title: 'Training 3', start_datetime: '2024-04-27T10:00:00', end_datetime: '2024-04-27T12:00:00', user_id: 9, description: 'Training session on new software', event_type: 3, creator_id: 3, pending: false, approved: true },
    { title: 'Meeting 3', start_datetime: '2024-04-28T11:00:00', end_datetime: '2024-04-28T12:00:00', team_id: 1, description: 'Weekly team meeting', event_type: 2, creator_id: 1, pending: false, approved: true },
    { title: 'Project Deadline', start_datetime: '2024-04-29T00:00:00', end_datetime: '2024-04-29T23:59:59', team_id: 1, description: 'Project ABC deadline', event_type: 2, creator_id: 2, pending: false, approved: true },
    { title: 'Training 4', start_datetime: '2024-04-30T13:00:00', end_datetime: '2024-04-30T16:00:00', user_id: 12, description: 'Training session on communication skills', event_type: 3, creator_id: 3, pending: false, approved: true },
    ...
    { title: 'Holiday 3', start_datetime: '2024-05-15T00:00:00', end_datetime: '2024-05-15T23:59:59', user_id: 7, description: 'Public holiday', event_type: 4, creator_id: 3, pending: false, approved: true },
    { title: 'Team Workshop', start_datetime: '2024-05-16T09:00:00', end_datetime: '2024-05-16T17:00:00', team_id: 2, description: 'Team brainstorming workshop', event_type: 2, creator_id: 1, pending: false, approved: true },
    { title: 'Training 9', start_datetime: '2024-05-17T10:00:00', end_datetime: '2024-05-17T12:00:00', user_id: 9, description: 'Training session on leadership skills', event_type: 3, creator_id: 2, pending: false, approved: true },
    { title: 'Random Meeting 7', start_datetime: '2024-05-19T11:00:00', end_datetime: '2024-05-19T12:00:00', team_id: 1, description: 'Weekly team meeting', event_type: 2, creator_id: 20 },
    { title: 'Random Meeting 8', start_datetime: '2024-05-20T11:00:00', end_datetime: '2024-05-20T12:00:00', team_id: 2, description: 'Weekly team meeting', event_type: 2, creator_id: 17 },
    { title: 'Random Meeting 6', start_datetime: '2024-05-21T11:00:00', end_datetime: '2024-05-20T12:00:00', team_id: 1, description: 'Weekly team meeting', event_type: 2, creator_id: 9 }
  ]);
};
